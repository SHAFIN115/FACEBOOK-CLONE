                                ...
                                <div class="card mt-3">
                                    <div class="card-body">
                                        ...
                                        <ul class="card-text mb-1">
                                            <li class="mt-1">Lives in Dhaka</li>
                                            <li class="mt-1">DRMC</li>
                                            <li class="mt-1">Went to KUET</li>
                                            <li class="mt-1">Studied Bachelor of Science in CSE at KUET</li>
                                        </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="col-md-3 m-2">
                                                ...
                                                <h6><small>Shafin Junayed</small></h6>
                                            </div>
                                            <div class="col-md-3 m-2">
                                                <div class="card">
                                                    <img src="https://i.pravatar.cc/80?u={{auth()->user()->email}}" class="rounded">
